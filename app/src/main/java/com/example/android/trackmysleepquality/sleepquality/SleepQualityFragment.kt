...
class SleepQualityFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        //Get arguments
        val sleepNightId = SleepQualityFragmentArgs.fromBundle(arguments!!)
        val sleepDatabaseDao = SleepDatabase.getInstance(application).SleepDatabaseDao

        //ViewModel
        val viewModelFactory = SleepQualityViewModelFactory(sleepNightId = sleepNightId.sleepNightKey, sleepDatabaseDao = sleepDatabaseDao)
        ...
        sleepQualityViewModel.navigateToSleepTracker.observe(this, Observer {
            if (it == true) {
                ...
                sleepQualityViewModel.doneWithNavigation()
            }
        })
